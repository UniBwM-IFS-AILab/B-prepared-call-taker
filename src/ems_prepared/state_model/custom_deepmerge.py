...
def strategy_length_nonzero(  # noqa: D103
    config: Merger, path, base: T, nxt: T
) -> T:
...
"""Keeps the old value unless the new value does not represent some kind of emptiness."""  # noqa: E501
